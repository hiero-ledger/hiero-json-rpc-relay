...
export const TOPICS_ERROR = `Expected an array or array of arrays containing 0x prefixed strings representing topic hashes (32 bytes), with at most ${mainConstants.LOG_TOPICS_MAX_POSITIONS} positions and at most ${mainConstants.LOG_TOPICS_MAX_SUB_TOPICS} topics per position`;
