...
export interface TransactionPoolService {
   ...
   */
  getConfirmedCount(address: string): Promise<{ value: number; version: string } | null>;
   ...
   */
  setConfirmedCount(address: string, entry: { value: number; version: string }): Promise<void>;
}
