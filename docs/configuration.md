...
| `DISABLE_ADMIN_NAMESPACE`          | "false"                                                                                                                                                                  | The JSON-RPC Relay provide custom methods under the `hedera_` namespace. This flag enables or disables access to this namespace. Enabled by default.                                                                              |
