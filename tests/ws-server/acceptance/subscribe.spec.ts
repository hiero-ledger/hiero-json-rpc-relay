  ...
  describe('ethSubscribe Logs Params Validations', async function () {
    ...
    it('Calling eth_subscribe Logs with an invalid topics should fail', async function () {
      const expectedError = predefined.INVALID_PARAMETER(
        ...
        `Expected an array or array of arrays containing Expected 0x prefixed string representing the hash (32 bytes) of a topic, with at most 4 positions and at most 100 topics per position, value: ["0x000"]`,
      );
