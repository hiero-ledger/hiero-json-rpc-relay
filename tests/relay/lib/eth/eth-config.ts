...
//EXPECTED_GAS_USED_RATIO comes from gasUsed 1_000_000 / 30_000_000 gasLimit for the test block (hapi version 0.28.1)
export const EXPECTED_GAS_USED_RATIO = DEFAULT_BLOCK.gas_used / 30_000_000;
