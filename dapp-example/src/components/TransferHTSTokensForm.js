  ...
  return (
    <>
      ...
      <Typography variant="h6" color="orange">
        {' '}
        Make sure that the receiving address is associated to the specified HTS token{' '}
      </Typography>
      <TextField
      ...
      <br />
      <Button
        id="htsTokenTransferBtn"
        onClick={htsTokenTransfer}
      ...
      <br />
      <Typography id="htsTokenMsg" variant="h6">
        {' '}
        {htsTokenMsg}{' '}
      </Typography>
    </>
