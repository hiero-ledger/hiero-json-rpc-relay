...
export default {
  ...
  LOGGER_CHILD_NAME: {
    ...
    EVM_ADDRESS_SPENDING_PLAN_REPOSITORY: 'evm-address-spending-plan-repository',
    FILTER_SERVICE: 'filter-service',
    HBAR_RATE_LIMIT: 'hbar-rate-limit',
    HBAR_SPENDING_PLAN_CONFIG_SERVICE: 'hbar-spending-plan-config-service',
    HBAR_SPENDING_PLAN_REPOSITORY: 'hbar-spending-plan-repository',
    IP_ADDRESS_SPENDING_PLAN_REPOSITORY: 'ip-address-spending-plan-repository',
    IP_RATE_LIMIT: 'ip-rate-limit',
    KOA_RPC: 'koa-rpc',
    LOCAL_LRU_CACHE: 'localLRUCache',
    METRICS_TEST_CLIENT: 'metrics-test-client',
    MIRROR_NODE: 'mirror-node',
    MIRROR_NODE_TEST_CLIENT: 'mirror-node-test-client',
    POLLER: 'poller',
    REDIS_CACHE: 'redisCache',
    REDIS_IN_MEMORY_SERVER: 'RedisInMemoryServer',
    REDIS_RATE_LIMIT_STORE: 'redis-rate-limit-store',
    RELAY: 'relay',
    RELAY_ETH: 'relay-eth',
    RELAY_TEST_CLIENT: 'relay-test-client',
    RPC_ACCEPTANCE_TEST: 'rpc-acceptance-test',
