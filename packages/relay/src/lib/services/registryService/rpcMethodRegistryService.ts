...
export class RpcMethodRegistryService {
   ...
   * @rpcMethod and registers them in a map using the convention namespace_methodName
      ...
      Object.getOwnPropertyNames(prototype)
        ...
        .forEach((operationName) => {
          ...
          if (operationFunction && operationFunction[RPC_METHOD_KEY] === true) {
            // Create the full RPC method ID in format: namespace_methodName (e.g., eth_blockNumber)
