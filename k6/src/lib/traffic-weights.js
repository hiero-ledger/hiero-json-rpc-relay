...
export const trafficWeights = {
  ...
  eth_getBlockByNumber_withManySyntheticTxs: 0.005,
  eth_getBlockByHash_withManySyntheticTxs: 0.001,
  eth_getBlockReceipts_withManySyntheticTxs: 0.0005,
  eth_getLogs_withManySyntheticTxs: 0.0005,
