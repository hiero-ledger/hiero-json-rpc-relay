...
export default defineConfig([
  ...
  // This glob list grows with each commit and collapses to 'tests/**/*.ts' once `tests` is clean.
  {
    files: [
      ...
      'tests/server/acceptance/debug.spec.ts',
      'tests/server/acceptance/equivalence.spec.ts',
      'tests/server/acceptance/erc20.spec.ts',
      'tests/server/acceptance/estimateGasContract.spec.ts',
      'tests/server/acceptance/estimateGasPrecompile.spec.ts',
